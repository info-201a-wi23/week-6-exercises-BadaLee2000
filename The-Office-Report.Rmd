---
title: "Bada's The Office Report"
author: "Bada"
date: '02-07-2023'
output:
...
![](https://images6.fanpop.com/image/photos/40100000/The-Office-the-office-40154918-700-461.jpg)
...
lowest_rating <- office_df %>% filter(Rating == min(Rating, na.rm = TRUE))
```
